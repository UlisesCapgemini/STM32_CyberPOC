...
Application/Startup/startup_stm32l5xx_ns.o: ../Application/Startup/startup_stm32l5xx_ns.S
	arm-none-eabi-gcc -mcpu=cortex-m33 -c -x assembler-with-cpp -MMD -MP -MF"Application/Startup/startup_stm32l5xx_ns.d" -MT"$@" --specs=nano.specs -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
